...
export PATH="/usr/local/heroku/bin:/opt/local/bin:/opt/local/sbin:/usr/local/apache-maven/apache-maven-3.2.5/bin:/opt/local/bin:/opt/local/sbin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/opt/X11/bin:/Library/TeX/texbin"
